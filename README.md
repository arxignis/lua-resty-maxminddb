...
luarocks install lua-resty-maxminddb-multi
    ...
    location / {
        content_by_lua_block{
            ...
            if not geo.initted() then
                geo.init({
                    city = "/path/to/maxmind/GeoIP2-City.mmdb",
                    isp  = "/path/to/maxmind/GeoIP2-ISP.mmdb",
                    asn  = "/path/to/maxmind/GeoLite2-ASN.mmdb",
                    conn = "/path/to/maxmind/GeoIP2-Connection-Type.mmdb"
                })
            end
